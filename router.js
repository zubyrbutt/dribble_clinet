...
const routes = [
  ...
  { path: '/verification/verify', name: 'verification.verify', component: page('auth/verification/verify.vue')},
  { path: '/password/email', name: 'password.email', component: page('auth/password/reset-email.vue')},
  { path: '/password/reset', name: 'password.reset', component: page('auth/password/password-reset.vue')}
]
